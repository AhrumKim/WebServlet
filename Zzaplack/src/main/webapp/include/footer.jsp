...
<script
	src="resources/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>
<script
...
<script src="resources/dist/js/pages/dashboards/dashboard1.min.js"></script>
</body>
